const Privacy = () => {
  return (
    <div className="px-4 gap-4 flex flex-col ">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Daniel Rubin, Sportplatzstraße 4 84051
            Essenbach.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Bayern, Germany
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Daniel Rubin, accessible from{" "}
            <a
              href="https://daniel-rubin.de/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://daniel-rubin.de/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: contact@daniel-rubin.de</p>
        </li>
        <li>
          <p>
